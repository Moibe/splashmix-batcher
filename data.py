...
lista_wardrobe_accesories = ["shackle choke", "shackles", "shackles and chains", "butt plug", "", "fox tail", "", "cat tail", "princess crown", "diadem", "", "diadema", "", "choke", "", "bubble gum", "nose piercing", "garter belt"]
lista_wardrobe_bottom = ["babydoll", "", "skirt", "babydoll", "", "shorts",  "school uniform", "babydoll", "tight shorts", "cocktail dress", "babydoll", "cocktail dress with cleavage", "cocktail dress with sequins", "cocktail tight dress with sequins", "executive dress",  "tight dress"]
lista_wardrobe_shoes = ["high heels","heels", "high socks", "with shackles in her feet"]
lista_situacion = ["chained", "hogtied", "tied", "", "with a shackle around her neck", "a rope around her neck", "an slave chain around her neck", "chained in shackles"]
